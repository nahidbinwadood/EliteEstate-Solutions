...
const UpdateUserModal = ({ setIsOpen, isOpen, modalHandler, user,role}) => {
  return (
            ...
            >
              <DialogPanel className="w-full h-56 max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="py-8 w-full">
                  <h2 className=" text-center">Are you sure to make <span className="font-semibold">{user.name}</span> Admin?</h2>
                </div>
                <hr className="mt-2 " />
