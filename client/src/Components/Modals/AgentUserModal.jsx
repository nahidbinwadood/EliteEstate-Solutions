...
const AgentUserModal = ({ setIsOpenAgent, isOpenAgent, modalHandlerAgent, user,role}) => {
  return (
    <Transition appear show={isOpenAgent} as={Fragment}>
      <Dialog
        as="div"
        className="relative z-10"
        onClose={() => setIsOpenAgent(false)}
      >
        <TransitionChild
          as={Fragment}
            ...
            >
              <DialogPanel className="w-full h-56 max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="py-8 w-full">
                  <h2 className=" text-center">Are you sure to make <span className="font-semibold">{user.name}</span> Agent ?</h2>
                </div>
                <hr className="mt-2 " />
                ...
                <div className="flex mt-4 justify-center  gap-5">
                  <button
                    ...
                    onClick={() => modalHandlerAgent(role)}
                  >
                    Yes,Make him 
                  </button>
                  <button
...
AgentUserModal.propTypes = {
  user: PropTypes.object,
  modalHandlerAgent: PropTypes.func,
  setIsOpenAgent: PropTypes.func,
  isOpenAgent: PropTypes.bool,
};

export default AgentUserModal;
